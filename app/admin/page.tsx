...
export default function AdminDashboardPage() {
  ...
  if (loading) {
    return (
      <AdminLayout>
        <LoadingScreen message="Aggregating institutional skill distributions and placement funnels..." />
      </AdminLayout>
    );
  }

  const { stats, mostDemandedSkills = [], funnel, skillGapDistribution = [] } = data || {};
