...
export default function ProfilePage() {
  ...
  if (loading) {
    return (
      <StudentLayout>
        <LoadingScreen message="Loading full student profile and scoring breakdown..." />
      </StudentLayout>
    );
  }
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-slate-500 text-sm mt-1">
              Every verified modification updates your Profile Score (0-100) and recommendation matching in real-time.
            </p>
          </div>
        </div>
