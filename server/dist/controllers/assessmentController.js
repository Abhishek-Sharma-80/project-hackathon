...
exports.submitAssessment = exports.getQuestionsForSkill = exports.getAssessmentSkills = void 0;
const prisma_1 = __importDefault(require("../config/prisma"));
const profileScoreEngine_1 = require("../services/profileScoreEngine");
const getAssessmentSkills = async (req, res) => {
    try {
        ...
        const skillList = await prisma_1.default.skill.findMany({
            where: {
...
exports.getAssessmentSkills = getAssessmentSkills;
const getQuestionsForSkill = async (req, res) => {
    try {
...
exports.getQuestionsForSkill = getQuestionsForSkill;
const submitAssessment = async (req, res) => {
    try {
        ...
        const existingStudentSkill = await prisma_1.default.studentSkill.findUnique({
            where: {
                studentId_skillId: {
        ...
        const assessment = await prisma_1.default.skillAssessment.create({
            data: {
                studentId: studentProfile.id,
                skillId: skill.id,
                score: correctCount,
        ...
        if (updatedProfile) {
            const score = (0, profileScoreEngine_1.calculateProfileScore)(updatedProfile);
        ...
        res.json({
            ...
            nextRecommendations: updatedLevel >= 80
