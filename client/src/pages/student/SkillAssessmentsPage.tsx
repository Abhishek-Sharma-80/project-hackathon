...
import { Award, CheckCircle2, Clock, Sparkles, ArrowRight, BookOpen, ShieldCheck } from 'lucide-react';
...
export const SkillAssessmentsPage: React.FC = () => {
  ...
  if (loading) {
    return <LoadingScreen message="Loading verified skill assessment matrix..." />;
  }
        ...
        {assessments.map((item) => (
          ...
          >
            ...
            <div className="mt-6 pt-4 border-t border-slate-100">
              <Link
                to={`/assessments/${encodeURIComponent(item.name)}`}
