...
export const CareerInsightsPage: React.FC = () => {
  ...
  if (loading) {
    return <LoadingScreen message="Synthesizing multidimensional career readiness telemetry..." />;
  }
    ...
    <div className="space-y-8 animate-fadeIn max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="p-6 rounded-3xl bg-white border border-slate-200 shadow-sm flex flex-col items-center justify-center text-center">
          <span className="text-xs font-bold text-slate-400 uppercase tracking-wider mb-2">Overall Career Readiness</span>
          <CircularProgress
