...
import { AlertTriangle, ShieldCheck, Mail, ArrowRight, CheckCircle2, User } from 'lucide-react';
...
export const AdminInterventionsPage: React.FC = () => {
  ...
  if (loading) {
    return <LoadingScreen message="Scanning student population for career readiness anomalies..." />;
  }
